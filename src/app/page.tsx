    ...
    <div className="bg-primary-dark">
      ...
      <section className="min-h-screen flex items-center justify-center pt-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <ScrollReveal direction="right" className="relative h-96 md:h-full min-h-[500px]">
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 mb-12">
          ...
          <ScrollReveal direction="right" className="md:w-1/2 flex justify-center items-center">
      ...
      <section className="bg-primary-lighter py-20">
        <ScrollReveal direction="up">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-12 text-center">Key Benefits</h2>
        </ScrollReveal>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        <ScrollReveal direction="up">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-12 text-center">Shop by Category</h2>
        </ScrollReveal>
